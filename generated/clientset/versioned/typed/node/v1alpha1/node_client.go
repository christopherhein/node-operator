...
import (
	...
	"github.com/christopherhein/node-operator/generated/clientset/versioned/scheme"
...
// NodeV1alpha1Client is used to interact with features provided by the node.chrishein.com group.
type NodeV1alpha1Client struct {
	restClient rest.Interface
}

func (c *NodeV1alpha1Client) AuthorizedKeys() AuthorizedKeyInterface {
	return newAuthorizedKeys(c)
}
