...
import (
	...
	"github.com/christopherhein/node-operator/pkg/client/clientset/versioned/scheme"
...
type NodeV1Interface interface {
	...
	AuthorizedKeysGetter
}

// NodeV1Client is used to interact with features provided by the node.io group.
type NodeV1Client struct {
	restClient rest.Interface
}

func (c *NodeV1Client) AuthorizedKeys(namespace string) AuthorizedKeyInterface {
	return newAuthorizedKeys(c, namespace)
}
